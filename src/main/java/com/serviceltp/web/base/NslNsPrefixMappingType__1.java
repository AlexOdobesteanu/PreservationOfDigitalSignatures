...
public class NslNsPrefixMappingType__1 {
    ...
    public String toString() {
        ...
        sb.append(NslNsPrefixMappingType__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("uri");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NslNsPrefixMappingType__1) == false) {
            return false;
        }
        NslNsPrefixMappingType__1 rhs = ((NslNsPrefixMappingType__1) other);
