...
public class MdExtensionType {
    ...
    public String toString() {
        ...
        sb.append(MdExtensionType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MdExtensionType) == false) {
            return false;
        }
        MdExtensionType rhs = ((MdExtensionType) other);
