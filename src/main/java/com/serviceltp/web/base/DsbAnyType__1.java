...
public class DsbAnyType__1 {
    ...
    private String val;
    @JsonProperty("attRef")
    private DsbAttachmentReferenceType__1 attRef;
    @JsonProperty("transforms")
    private DsigrwTransformsType__1 transforms;
    ...
    @JsonProperty("attRef")
    public DsbAttachmentReferenceType__1 getAttRef() {
        return attRef;
    }

    @JsonProperty("attRef")
    public void setAttRef(DsbAttachmentReferenceType__1 attRef) {
        this.attRef = attRef;
    }

    @JsonProperty("transforms")
    public DsigrwTransformsType__1 getTransforms() {
        return transforms;
    }

    @JsonProperty("transforms")
    public void setTransforms(DsigrwTransformsType__1 transforms) {
    ...
    public String toString() {
        ...
        sb.append(DsbAnyType__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DsbAnyType__1) == false) {
            return false;
        }
        DsbAnyType__1 rhs = ((DsbAnyType__1) other);
