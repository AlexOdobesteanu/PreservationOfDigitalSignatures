...
public class PresPOTypeBinaryData {
    ...
    public String toString() {
        ...
        sb.append(PresPOTypeBinaryData.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("value");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PresPOTypeBinaryData) == false) {
            return false;
        }
        PresPOTypeBinaryData rhs = ((PresPOTypeBinaryData) other);
