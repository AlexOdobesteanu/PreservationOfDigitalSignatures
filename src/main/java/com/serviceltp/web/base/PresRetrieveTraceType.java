...
public class PresRetrieveTraceType {
    ...
    public String toString() {
        ...
        sb.append(PresRetrieveTraceType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("optIn");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PresRetrieveTraceType) == false) {
            return false;
        }
        PresRetrieveTraceType rhs = ((PresRetrieveTraceType) other);
