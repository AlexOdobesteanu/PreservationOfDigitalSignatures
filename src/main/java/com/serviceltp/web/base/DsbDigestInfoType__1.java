...
public class DsbDigestInfoType__1 {
    ...
    public String toString() {
        ...
        sb.append(DsbDigestInfoType__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("alg");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DsbDigestInfoType__1) == false) {
            return false;
        }
        DsbDigestInfoType__1 rhs = ((DsbDigestInfoType__1) other);
